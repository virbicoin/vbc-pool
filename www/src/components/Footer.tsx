    ...
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="container mx-auto px-2 py-2 flex items-center justify-center text-gray-400">
        <div className="space-x-2 text-sm flex items-center">
          ...
          <span>|</span>
          <a
            href="https://github.com/virbicoin/open-virbicoin-pool"
            target="_blank"
          ...
          <span>Pool VBC:</span>
          <a
            href="https://explorer.digitalregion.jp/address/0x950302976387b43E042aeA242AE8DAB8e5C204D1"
            target="_blank"
            rel="noopener noreferrer"
            className="font-mono hover:text-gray-100 transition-colors"
          >
